 ...
 * @author Sparsh
 */
public class runDB extends StudentOperationsDB {
    ...
    public static void main(String ar[]) throws IOException {
        ...
        runDB rdb = new runDB();
        StudentOperationsDB sdb = new StudentOperationsDB();
        System.out.println("Student Record System | Database Implementation");
        rdb.displayMenu();
        ch = sc.nextInt();
        while (ch != 6) {
            switch (ch) {
